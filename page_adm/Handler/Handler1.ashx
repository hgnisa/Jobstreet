...
Public Class Handler1 : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        'Create SQL Command
        cmd.CommandText = "SELECT app_cv FROM application WHERE app_id = @app_id"
        ...
        dreader.Read()
        context.Response.BinaryWrite(DirectCast(dreader("app_cv"), Byte()))
        dreader.Close()
        con.Close()
    End Sub
